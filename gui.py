...
def show_classify_button(file_path):
    classify_b = Button(top, text="Classify Image", command=lambda: classify(file_path), padx=15, pady=7)
    classify_b.configure(background='#34A853', foreground='white', font=('Comic Sans MS', 15, 'bold'))
    classify_b.place(relx=0.1, rely=0.46)
...
upload = Button(top, text="Upload an image", command=upload_image, padx=25, pady=10)
...
heading = Label(top, text="Know Your Traffic Sign", pady=30, font=('Comic Sans MS', 40, 'bold'))
